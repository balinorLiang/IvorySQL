...
::>>config.pl		echo $config-^>{license} = '%2\deps\lib%up_x64%\license';
...
::>>buildenv.pl	echo    '%2\deps\lib%up_x64%\license\lib;'.
...
::>>instal.bat	echo copy %2\deps\lib%up_x64%\license\share\license.dll %%1\bin
